...
const RequestHistory = () => {
    ...
    useEffect(() => {
        ...
        fetch("http://localhost:5001/api/v1/transactionsByLandLordStatus?id=fjvbf&status=1", requestOptions)
        ...
        fetch("http://localhost:5001/api/v1/transactionsByLandLordStatus?id=1237jhcdh&status=-1", requestOptions)
            .then(response => response.json())
            .then(result => {
                console.log(result)
                setFailed(result);
            ...
            <div className="row">
                ...
                <main role="main" className="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                    <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                        <h1 className="h2">{t('addressBorrow')}</h1>
                    ...
                    <h2><i>{t('successfulRequests')}</i></h2>
